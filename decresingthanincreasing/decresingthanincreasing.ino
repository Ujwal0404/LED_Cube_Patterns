    ...
    if(c==1)
            {
                                               for(j=1;j<=10;j++)
                                               for(int i=1;i<=10;i++)
                                               RGBLED_Coordinates(c,i,j,'b',1);delay(t);resetAll();  
...
//                                               for(j=1;j<=10;j++)
//                                               for(int i=1;i<=10;i++)
//                                               RGBLED_Coordinates(i,c,j,'b',1);delay(t);resetAll();                                                   
//            }
//    else if(c==2)
//            {
//                                               for(j=2;j<=9;j++)
//                                               for(int i=2;i<=9;i++)
//                                               RGBLED_Coordinates(i,c,j,'r',1);delay(t);resetAll();                                                   
//            }
//    else if(c==3)
//            {
//                                               for(j=3;j<=8;j++)
//                                               for(int i=3;i<=8;i++)
//                                               RGBLED_Coordinates(i,c,j,'g',1);delay(t);resetAll();                                                   
//            }
//    else if(c==4)
//            {
//                                               for(j=4;j<=6;j++)
...
//                                               for(j=1;j<=10;j++)
//                                               for(int i=1;i<=10;i++)
//                                               RGBLED_Coordinates(i,j,c,'b',1);delay(t);resetAll();                                                   
//            }
//    else if(c==2)
//            {
//                                               for(j=2;j<=9;j++)
//                                               for(int i=2;i<=9;i++)
//                                               RGBLED_Coordinates(i,j,c,'r',1);delay(t);resetAll();                                                   
//            }
//    else if(c==3)
//            {
//                                               for(j=3;j<=8;j++)
//                                               for(int i=3;i<=8;i++)
//                                               RGBLED_Coordinates(i,j,c,'g',1);delay(t);resetAll();                                                   
//            }
//    else if(c==4)
//            {
//                                               for(j=4;j<=6;j++)
